...
let classifier;
// let modelURL = 'https://teachablemachine.withgoogle.com/models/3rJQy5H-7/';

// STEP 1: Load the model!

function preload() {
  // Load the model
  classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/3rJQy5H-7/');
}
