...
//- Update rectangle's position in a grid pattern.
//- Use the received serial data (`inData`) to set the fill // color of the rectangle.
...
//******** Convert data from arduino raw to Number for p5 
